  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-white">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className="w-full md:w-[400px] lg:w-[450px] flex flex-col border-r border-gray-200 bg-white z-10">
           {/* Filters Header */}
        ...
        <main className="hidden md:flex flex-1 flex-col bg-gray-50 relative">
            <div className="flex-1 flex flex-col max-w-4xl mx-auto w-full h-full p-6">
               ...
               <div className="mt-4 bg-white p-2 rounded-2xl shadow-sm border border-gray-200 flex items-center gap-2">
                  <input 
                    type="text" 
                    className="flex-1 bg-transparent px-4 py-3 outline-none text-dark placeholder:text-gray-400"
                    placeholder="Pregunta sobre las empresas o pide recomendaciones..."
                    value={chatInput}
