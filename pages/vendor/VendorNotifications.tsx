...
const notificationTypes = [
  ...
  { value: 'MILESTONE_APPROVED,MILESTONE_REJECTED', label: 'Hitos' },
  { value: 'PAYMENT_APPROVED,PAYMENT_REJECTED,PAYMENT_COMPLETED', label: 'Pagos' },
  { value: 'MESSAGE_RECEIVED', label: 'Mensajes' },
  { value: 'FILE_UPLOADED', label: 'Archivos' },
  { value: 'CONTRACT_SIGNED', label: 'Contratos' },
  { value: 'EVENT_ACCEPTED,EVENT_REJECTED', label: 'Calendario' },
  { value: 'PROJECT_CREATED,PROPOSAL_ACCEPTED,PROPOSAL_REJECTED', label: 'Proyectos' }
];
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 flex-1">
              ...
              <div className="flex items-center gap-2 bg-gray-50 p-1 rounded-lg">
                {dateFilters.map(filter => (
                  <button
                    key={filter.value}
                    onClick={() => setDateFilter(filter.value)} className={`px-3 py-1.5 rounded-md text-xs font-medium transition-all ${dateFilter === filter.value
