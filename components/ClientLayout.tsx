  ...
  return (
    <div className={`flex flex-col bg-[#f6f6f8] min-h-screen`}>
      ...
      <div className="flex flex-1 max-w-[1920px] mx-auto w-full relative">
        ...
        <aside 
          className={`
            bg-white border-r border-gray-200 flex-col flex-shrink-0 sticky top-20 h-[calc(100vh-80px)] overflow-y-auto custom-scrollbar transition-all duration-300 ease-in-out
            ${isSidebarOpen ? 'w-64 translate-x-0' : 'w-0 -translate-x-full overflow-hidden opacity-0 md:opacity-100'}
            hidden md:flex
          `}
        >
           <div className="p-4 py-6 w-64">
        ...
        <main className={`flex-1 flex flex-col min-w-0 transition-all duration-300`}>
           ...
           <div className="bg-white border-b border-gray-200 px-6 py-3 flex items-center shadow-sm shrink-0 gap-4 sticky top-20 z-30">
              ...
              <button 
                ...
                className="text-gray-500 hover:text-primary hover:bg-gray-50 p-1.5 rounded-md transition-colors hidden md:block"
